...
#define TEST_VOXEL_INTERSECTOR 1
#if TEST_VOXEL_INTERSECTOR
ref<rt::intersector> get_voxel_bvh();
...
// create a bvh of voxels
ref<task> create_voxel_task(octree&, const csg::node&, const vec3f&, u32 cellnum, float cellsize);
